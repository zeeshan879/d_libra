...
import { courseAndChapterTable, getParentChildCategories } from "../../../Redux/Actions/Editor/Category";
...
const CourseAndChapter = () => {
  ...
  const ParentChildCategories = async () => {
    const responseTwo = await dispatch(courseAndChapterTable(role, token));
...
export default CourseAndChapter;
