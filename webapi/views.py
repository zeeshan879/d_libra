            ...
            if my_token:
                ...
                if validator:
                    ...
                    if 'Categoryid' not in request.data:
                        ...
                        return Response({'status':'error','message':'Category Key are required'})
                    ...
                    if Categoryid == "":
                        ...
                        data = Category(name=name,slug=slug,image=image,unique_identifier = uc.randomcodegenrator(),parent = Category.objects.filter(id = Categoryid).first())
                        data.save()
